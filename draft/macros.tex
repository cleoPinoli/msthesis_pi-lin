...
\newcommand{\Select}[3]{#1 \triangleleft #2\ifblank{#3}{}{\parens{#3}}}
...
\newcommand{\OneCase}[3]{\mkkeyword{case}\,#1\ifblank{#2}{}{\parens{#2}}#3}
\newcommand{\Case}[4]{\OneCase{#1}{#2}{\braces{#3,#4}}}
\newcommand{\BigCase}[2]{\OneCase{#1}{\left\{\begin{array}{@{}r@{~:~}l@{}}#2\end{array}\right\}}}
\newcommand{\Fork}[5]{#1\angles{#2\ifblank{#3}{}{,#3}}\braces{#4,#5}}
