...
\newcommand{\Select}[3]{#1 \triangleleft #2\parens{#3}}
...
\newcommand{\OneCase}[3]{\mkkeyword{case}\,#1\parens{#2}#3}
\newcommand{\Case}[4]{\OneCase{#1}{#2}{\braces{#3,#4}}}
\newcommand{\BigCase}[2]{\OneCase{#1}{\left\{\begin{array}{@{}r@{~:~}l@{}}#2\end{array}\right\}}}
\newcommand{\Fork}[5]{#1\angles{#2,#3}\braces{#4,#5}}
\renewcommand{\Join}[3]{#1\parens{#2,#3}}
...
\newcommand{\SCall}{\rulename{s-call}}
\newcommand{\SCut}{\rulename{s-cut}}
...
\newcommand{\SWeak}{\rulename{s-weak}}
\newcommand{\SLink}{\rulename{s-link}}

\newcommand{\RLink}{\rulename{r-link}}
\newcommand{\RChoice}{\rulename{r-choice}}
...
\newcommand{\RErase}{\rulename{r-erase}}
