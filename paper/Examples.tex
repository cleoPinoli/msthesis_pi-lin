...
\end{code}
    ...
    However, now we have to make a distinction between the first arrow
    \AgdaFunction{⇒} and the following magic wands to account for the
    appropriate amount of context splittings. We found this formulation of the
    constructors harder to explain and motivate in \Cref{sec:process-agda}.
    %
    Since none of the alternative definitions of \AgdaDatatype{Proc} was fully
    satisfactory, we preferred the cleanest and most readable version of the
    data type at the expense of additional clutter in this section.
    %
    \eoe
\end{remark}
