...
polymorphic in the sense that the type of the value it receives and sends back
is arbitrary and denoted by a type variable $X$. The notation
$\AgdaFunction{\#}~n$ is defined in Agda's standard library and creates an
element of \AgdaDatatype{Fin} from the natural number $n$.
