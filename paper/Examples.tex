...
In this section we revisit the processes discussed in \Cref{ex:booleans,ex:echo}
and show their encoding in our formalisation. The encoding of $\Bool$ is
straightforward.
...
visible function application operator. We use it here as ``separator'' to save a
few parentheses.
%
