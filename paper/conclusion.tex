...
possibly infinite) types, recursive processes \REVISION{and context-free session
types (these extensions} are in \LCC's public
repository~\cite{PadovaniRaffaelli25}). In the future, it would be interesting
