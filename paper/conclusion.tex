...
The compact formalisation we have presented is very much tailored to the
specific features of \Calculus and, in our opinion, it is hardly reusable in
...
(\ie possibly infinite) types, recursive processes and context-free session
types (these extensions are in \LCC's public
repository~\cite{PadovaniRaffaelli25}).
%
At the level of the syntax and of the typing rules, the extension of \LCC with
the so-called \emph{mix rule}, which allows the parallel composition of
