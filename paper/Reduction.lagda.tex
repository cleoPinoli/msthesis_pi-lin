...
While the constructor \AgdaInductiveConstructor{close} implicitly refers to the
only free channel occurring in a process of the form $\Close\x$, the constructor
\AgdaInductiveConstructor{wait} uses a splitting proof of the form
