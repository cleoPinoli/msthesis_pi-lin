...
The definition of \AgdaDatatype{\_↭\_} data type is nearly the same found in the
module \AgdaModule{Data.List.Relation.Binary.Permutation.Propositional} of
...
\AgdaInductiveConstructor{swap} and \AgdaInductiveConstructor{prep} can be made
implicit, which streamlines the usage of these constructors in the rest of the
code.
...
following we will make use of a specific property that relates context
splitting, list concatenation and permutations: if
