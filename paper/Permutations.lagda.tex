...
$\Context$ must be a permutation of
$A~\AgdaInductiveConstructor{∷}~\ContextD$.\Luca{Ci sono molte altre proprietà
non descritte, controllare quelle che servono davvero.}
