...
in \Cref{tab:semantics}, $\Context$ must be suitably rearranged to agree with
the updated binding structure. Such rearrangement is in fact a
...
following we also use another specific property of permutations related to
context splitting and list concatenation \AgdaFunction{\_++\_}: if
