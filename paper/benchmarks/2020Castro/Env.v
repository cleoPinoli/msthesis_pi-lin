...
Section Environment.
  ...
  Notation "A --- B" := (difference A B)  (at level 80, right associativity). 
  Notation "A /:\ B" := (intersection A B) (at level 80, right associativity). 
  Notation "A \:/ B" := (union A B) (at level 80, right associativity). 
  ...
  Proof.
    ...
    + rewrite fnd_fcat; case: suppP=>[v|]-H; rewrite H//.
      - have Hf1: fnd c f1 = None by apply/fnd_supp; 
