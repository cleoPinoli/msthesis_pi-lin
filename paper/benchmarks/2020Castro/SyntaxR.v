...
Scheme tp_sort := Induction for tp Sort Prop
  with sort_tp := Induction for sort Sort Prop. 
...
Lemma ltn_pol_irreflexive : irreflexive ltn_pol. 
Proof.
    by case.
Qed.
