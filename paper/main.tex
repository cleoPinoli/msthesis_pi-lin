...
The source code of the formalisation described in this paper is available in a
public repository on GitHub~\cite{PadovaniRaffaelli25}.

\bmhead{Acknowledgements}

The authors are grateful to the anonymous reviewers for the detailed and
constructive feedback they have provided on an early version of the paper.
