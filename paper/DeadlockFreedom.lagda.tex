...
\emph{thread}, that is any process other than a cut. It is convenient to provide
a more fine-grained classification of threads, distinguishing between links,
input/output actions, and sometimes also whether such actions operate on free or
bound channels. We define predicates for each of these process classes:
