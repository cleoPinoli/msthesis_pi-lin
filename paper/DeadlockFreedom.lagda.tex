...
Observability, reducibility and aliveness are straightforward formalisations of
their pen-and-paper version:
...
threads introduced earlier pays off: instead of considering all the 21 forms of
cuts that can be rewritten/reduced according to the rules in
