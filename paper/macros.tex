...
\newcommand{\BEGINREVISION}{\color{purple}}
...
\newcommand{\Classical}[1]{\mathsf{#1}}
\newcommand{\ClassicalP}{\Classical{P}}
\newcommand{\ClassicalQ}{\Classical{Q}}
...
\newcommand{\wtp}[3][]{#2 \vdash\ifblank{#1}{}{_{#1}} #3}
\newcommand{\wtcp}[2]{\wtp[\text{\upshape\textsc{cp}}]{#1}{#2}}
...
\newcommand{\StandardForkRule}{\rulename{$\Ten$'}}
\newcommand{\StandardJoinRule}{\rulename{$\Par$'}}
\newcommand{\StandardSelectRule}{\rulename{$\Plus$'}}
\newcommand{\StandardCaseRule}{\rulename{$\With$'}}
\newcommand{\JoinRule}{\rulename{$\Par$}}
\newcommand{\SelectRule}[1][i]{\rulename{$\Plus_{#1}$}}
...
\newcommand{\nred}{\arrownot\red}
\newcommand{\eqdef}{\stackrel{\smash{\textsf{\footnotesize def}}}=}
