...
\texttt{{-}{-}rewriting} is enabled, either globally when invoking Agda or in
the module's preamble.}
...
thanks to the rewriting rule that we have added just above a use of
