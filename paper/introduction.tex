...
features \emph{linear channels} instead of sessions. Unlike session endpoints,
which can be used multiple times albeit sequentially, linear channels are meant
to be used \emph{once}. \LCC retains the expressiveness of modeling structured
conversations using \emph{explicit continuations}, just like in the well-known
...
sessions are encoded instead of being featured natively.
