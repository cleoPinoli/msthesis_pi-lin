...
exchange of several messages within the same session can be modeled in \LCP
using \emph{explicit continuations} according to the well-known encoding of
(binary) sessions into the linear
...
The logical foundations of \LCP and its use of explicit continuations play an
important role in taming the complexity of its formalisation.
%
...
%
From the standpoint of the formalisation, where the representation of channel
names is a primary design choice, it spares us the need to distinguish the two
...
%
\Cref{sec:agda} presents a roadmap of the Agda formalisation and discusses its
...
%
\Cref{sec:conclusion} summarises our contributions and discusses some ongoing
and future work.

The formalisation has been carried out using Agda and the source code is
