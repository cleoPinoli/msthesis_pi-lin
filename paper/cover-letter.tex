...
instead of being featured natively. The paper includes a thorough comparison
with related formalisations of linear/session calculi. Despite the low level of
abstraction of the calculus and the full range of features supported by its type
system, we show that the calculus allows for a remarkably simple formalisation.
