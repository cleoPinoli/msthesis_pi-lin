...
looked at those formalizations that include the following features:
\begin{itemize}
...
work to formalize a variant of the linear
...
studies is the formalization of a fragment of \GV~\citep{Wadler14}. The
...
All the formalizations mentioned so far make use of context splitting. In
contrast, \citet{ZalakainDardha21} formalize a generalization of the linear
...
contexts beforehand. As \citet{ZalakainDardha21} nicely summarize, ``context
...
\Cref{tab:comparison} summarizes the comparison of our formalization with the
...
formalizations differ widely for a variety of entangled factors including the
...
formalizations predate the publication of the linearity
...
be a good indicator of the complexity of the formalization, since it spans the
whole range of sizes. Our formalization is based on context splitting and it is
