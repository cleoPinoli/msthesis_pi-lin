...
\begin{table}[t]
    ...
    \begin{tabular}{@{}r|c|ccc|rr|rr|r@{~}l@{}}
        \textbf{Formalization} &
        ...
        -- &
        \textbf{177} &
        \footnote{Including support for subtyping and the interpreter.}
        \\
        ...
        -- &
        \textbf{77} &
        \footnote{Including support for dependent session types.}
        \\
        ...
        -- &
        \textbf{129} &
        \footnote{Excluding the correspondence between \CP and S\CP.}
        \\
        this work &
        Agda &
        linear \CP &
