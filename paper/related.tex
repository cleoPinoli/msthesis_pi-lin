...
\begin{itemize}
\item \cite{ChaudhuriLimaReis17} discuss representation of sequents and
    relations among them
\item \cite{Allais17} introduces leftovers intuitionistic linear logic, then
    reused in a session type setting by \cite{ZalakainDardha21}
\item \cite{XavierEtAl18} prove cut elimination and completeness of focusing for
    first-order linear logic, sequents are represented as lists of propositions
    with a notion of equivalence based on the number of occurrences of
    propositions "=mul="
\end{itemize}