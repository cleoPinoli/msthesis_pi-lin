...
the calculus being formalised. We provide its reference paper, the language in
...
the combination of restriction and parallel composition that corresponds with
the cut of linear logic) and continuations.
%
...
the same acronym may refer to different versions of the same calculus. In
particular, \GV in a logical setting is described by \citet{Wadler14} but its
