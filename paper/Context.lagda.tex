...
%
We begin using these definitions for building a few abstractions inspired by
...
which must comply with the typing rule \ServerRule.
...
if its head has the form $\WhyNot A$ for some $A$ and its tail is unrestricted
as well.
%
